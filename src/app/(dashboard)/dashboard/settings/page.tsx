          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Get notified when proposals are generated</p>
              </div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">24 proposals generated</p>
              </div>
              <span className="text-sm text-green-600 font-medium">80% remaining</span>
            </div>
          </div>
        </div>
