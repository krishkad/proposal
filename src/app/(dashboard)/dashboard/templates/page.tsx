  ...
  const templates = [
    {
      ...
      description:
        "Comprehensive proposal template for software as a service offerings",
      category: "SaaS",
    ...
    },
    {
      ...
      description:
        "Complete e-commerce platform setup and optimization proposal",
      category: "E-commerce",
      difficulty: "Intermediate",
      ...
      <div className=" p-6 max-w-7xl mx-auto">
          ...
          <div className="flex max-md:flex-col max-md:gap-8 max-md:items-start items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">
                Build your own reusable proposal template from scratch
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredTemplates.map((template) => (
            ...
            >
              <div
                className={`h-2 bg-gradient-to-r from-${template.color}-500 to-${template.color}-600`}
              ></div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-primary text-white px-4 py-2 rounded-lg font-medium hover:bg-primary transition-colors">
                    Use Template
                  </button>
                </div>
              </div>
